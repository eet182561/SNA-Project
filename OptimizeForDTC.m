...
ForGephyadjacencymatrix = zeros(30,30);
    ...
    for j = i:length(busroute1)
        if i ~= j
            if abs(find(busroute1 == busroute1(i)) - find(busroute1 == busroute1(j))) == 1
                ...
                adjacencymatrix(busroute1(j),busroute1(i)) = adjacencymatrix(busroute1(i),busroute1(j));
                ForGephyadjacencymatrix(busroute1(i),busroute1(j))=1;
                ForGephyadjacencymatrix(busroute1(j),busroute1(i))=1;
            end
        end
    end
end
    ...
    for j = i:length(busroute2)
        if i ~= j
            if abs(find(busroute2 == busroute2(i)) - find(busroute2 == busroute2(j))) == 1
                ...
                adjacencymatrix(busroute2(j),busroute2(i)) = adjacencymatrix(busroute2(i),busroute2(j));
                ForGephyadjacencymatrix(busroute2(i),busroute2(j)) = 1;
                 ForGephyadjacencymatrix(busroute2(j),busroute2(i)) =  ForGephyadjacencymatrix(busroute2(i),busroute2(j));
            end
        end
    end
end
    ...
    for j = i:length(busroute3)
        if i ~= j
            if abs(find(busroute3 == busroute3(i)) - find(busroute3 == busroute3(j))) == 1
                ...
                adjacencymatrix(busroute3(j),busroute3(i)) = adjacencymatrix(busroute3(i),busroute3(j));
                 ForGephyadjacencymatrix(busroute3(i),busroute3(j)) = 1;
                 ForGephyadjacencymatrix(busroute3(j),busroute3(i)) =  ForGephyadjacencymatrix(busroute3(i),busroute3(j));
            end
        end
    end
end
